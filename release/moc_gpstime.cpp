...
void GpsTime::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GpsTime *_t = static_cast<GpsTime *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->reftime(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject GpsTime::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_GpsTime.data,
      qt_meta_data_GpsTime,  qt_static_metacall, nullptr, nullptr}
};
