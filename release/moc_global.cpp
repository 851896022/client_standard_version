...
QT_MOC_LITERAL(1, 7, 12), // "switchListen"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5), // "speak"
QT_MOC_LITERAL(4, 27, 3), // "str"
QT_MOC_LITERAL(5, 31, 5) // "doLog"

    },
    "Global\0switchListen\0\0speak\0str\0doLog"
};
...
void Global::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->switchListen(); break;
        case 1: _t->switchListen((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->speak((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: { bool _r = _t->doLog((*reinterpret_cast< QString(*)>(_a[1])));
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Global::switchListen)) {
                *result = 0;
                return;
            }
        }
