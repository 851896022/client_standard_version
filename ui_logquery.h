...
public:
    ...
    void setupUi(QFrame *LogQuery)
    {
        ...
        btnSaveToFile = new QPushButton(LogQuery);
        btnSaveToFile->setObjectName(QStringLiteral("btnSaveToFile"));

        horizontalLayout->addWidget(btnSaveToFile);
    ...
    void retranslateUi(QFrame *LogQuery)
    {
        ...
        dateTimeEditStart->setDisplayFormat(QApplication::translate("LogQuery", "yyyy-MM-dd hh:mm:ss", nullptr));
        label_2->setText(QApplication::translate("LogQuery", "\347\273\223\346\235\237\346\227\266\351\227\264", nullptr));
        dateTimeEditEnd->setDisplayFormat(QApplication::translate("LogQuery", "yyyy-MM-dd hh:mm:ss", nullptr));
        ...
        btnSaveToFile->setText(QApplication::translate("LogQuery", "\345\257\274\345\207\272", nullptr));
    } // retranslateUi
